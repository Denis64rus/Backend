...
?>
	...
	<div class="main-table">
		<h3 class="mb-3">Категории
			<a href="category-add.php" class="btn btn-success">Добавить</a></h3>
		    	...
		    	<tr>
				    ...
				    <td><?=$category['category'] ?></td>
				     <td>
				     	...
				     	<a href="category-edit.php?id=<?=$category['id'] ?>" class="btn btn-warning">Редактировать</a>
				     </td>
		    	</tr>
		    	<?php } ?>
		  	</tbody>
