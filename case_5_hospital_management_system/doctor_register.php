<?php
	...
	if (isset($_POST['register'])) {
		...
		if (count($error) == 0) {
			...
			$query = "INSERT INTO doctors(firstname,surname,username,email,gender,phone,password,salary,data_reg,status,profile) VAlUES('$firstname','$surname','$username','$email','$gender','$phone','$password','0',NOW(),'Pendding','doctor.jpg')";
					...
					<form method="post" style="background-color: lightcyan; padding: 46px;" class="my-2">
 						...
 						<input type="submit"
 							   ...
 							   style="margin-top: 15px;
 							   		  margin-left: 40%;"
 							   value="Регистрация">
 						<p>У меня уже есть аккаунт <a href="doctorlogin.php">Войти</a></p>
 					</form>
				</div>
				<div class="col-md-3"></div>
			</div>
