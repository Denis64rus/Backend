<?php
	...
	if (isset($_POST['login'])) {
		...
		if (empty($uname)) {
			...
			$error['login'] = "Ожидайте подтверждения от Администратора";
		}else if($row['status'] == "Rejected") {
			$error['login'] = "Попробуйте снова позже";
		}
		...
		if (mysqli_num_rows($res)) {
			...
			echo "<script>alert('Вы вошли как доктор')</script>";
...
<head>
	...
	<title>СУБ | Вход для Доктора</title>
</head>
	 		...
	 		<div class="row">
	 			...
	 			<div class="col-md-6">
	 				<form method="post" style="background-color: lightcyan; padding: 46px;" class="my-2">
 						<h3 style="text-align: center;">Вход для Доктора</h3><br>
 						...
 						<input type="submit"
 							   ...
 							   style="margin-top: 15px;
 							   		  margin-left: 40%;"
 							   value="Войти">
 						<p>У меня нет аккаунта <a href="doctor_register.php">Регистрация</a></p>
 					</form>
	 			</div>
	 			<div class="col-md-3"></div>
	 		</div>
